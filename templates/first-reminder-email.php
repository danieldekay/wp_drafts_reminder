...
<head>
    ...
    <title><?php echo esc_html(get_bloginfo('name')); ?> — Entwurfs-Erinnerung</title>
    <style>
        body {
...
<body>
    <div class="email-wrapper">
        <div class="email-header">
            <h1><?php echo esc_html(get_bloginfo('name')); ?> — Entwurfs-Erinnerung</h1>
        </div>
        <div class="email-body">
            ...
            <p class="intro">
                Sie haben die folgenden unveröffentlichten Entwürfe, die seit mehr als zwei Tagen nicht bearbeitet wurden:
            </p>
            <ul class="draft-list">
            ...
            <p class="footer-note">
                Bitte überlegen Sie, diese Entwürfe abzuschließen oder zu löschen, falls sie nicht mehr benötigt werden.
            </p>
